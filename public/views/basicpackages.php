...
<div class="container">
          ...
          <div class="price_table_heading">Basic Package</div>
                        <div class="price_table_body">
                            ...
                            <div class="price_table_row">Casket</div>
                            ...
                            <div class="price_table_row">100 Programs</div>
                            <div class="price_table_row">100 Prayer Cards/Book Markers</div>       
                            <div class="price_table_row">1 TVJ Death Announcement and no Gleaner Advertisment</div>                            
                        </div>
               ...
               <img src="../assets/img/garden1.png">
                </div>
                </div>

                <div class="added-package">
                <h3> Basic Package - Personal </h3>
                <p>Pick up, 2 Weeks Storage ($2000 per day thereafter), Embalm, Preparation, Hearse, Casket, Casket Spray,
                  SingleVault (Dovecot or Meadowrest), 100 Programs, 100 Book markers or Prayer cards, 1 TVJ Death Announcement</p>

                </div>


                <div class="added-package">
                <h3> Basic Package - Deluxe </h3>
                <p>Pick up, 2 Weeks Storage ($2000 per day thereafter), Embalm, Preparation, Hearse, Casket, Casket Spray,
                Vault ½ Double (Dovecot or Meadowrest), 100 Programs, 100 Book markers or prayer cards, 1TVJ Death Announcement,
                JUTC Bus & 50Buttons</p>

                </div>

                <div class="added-package">
                <h3> Basic Package - Deluxe Personal</h3>
                <p>Pick up, 2 Weeks Storage ($2000 per day thereafter), Embalm, Preparation, Hearse, Casket, Casket Spray,
                Single Vault (Dovecot or Meadowrest), 100 Programs, 100 Book markers or prayer cards, 1TVJ Death Announcement,
                JUTC Bus & 50Buttons</p>

                </div>

                <div class="added-package">
                <h3> Basic Package - Super</h3>
