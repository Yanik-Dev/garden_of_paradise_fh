...
<div class="container">
            <div class="row">
                  ...
                  <div class="col-md-3 col-sm-6 col-xs-12 float-shadow">     
                    <div class="recommended"><strong><span class="glyphicon glyphicon-heart" aria-hidden="true"></span>PREMIUM</strong></div>   
                    <div class="price_table_container">
                        <div class="price_table_heading">Paradise Package</div>
                        <div class="price_table_body">
                            ...
                            <div class="price_table_row">Regular or Fully-Customized Casket Piece</div>
                            <div class="price_table_row">Wreath + Arrangement</div>     
                            <div class="price_table_row">Hearse</div>   
                            <div class="price_table_row">Single Vault (Dovecot or Meadowrest)</div>     
                            <div class="price_table_row">200 Programs</div>
                            <div class="price_table_row">200 Prayer Cards or Book Markers + 50 Buttons</div>       
                            <div class="price_table_row">2 TVJ Death Announcement and 1 Gleaner Advertisment</div>                            
                        </div>
                        <a href="./request-quote.php?type=pp" class="btn btn-primary btn-lg btn-block">Request Quote</a>
                    </div>
                </div>
                ...
                <h3> Paradise Package - Deluxe</h3>
                <p>Pick up, 2 Weeks Storage ($2000 per day thereafter), Embalm, Preparation, Hearse, Regular or Semi-Customized Casket, Casket Spray, Wreath + Arrangement,
                  SingleVault (Dovecot or Meadowrest), 200 Programs, 200 Book markers or Prayer cards + 100 Buttons, 2 TVJ Death Announcement, 1 Gleaner Advertisment + 1 JUTC Bus</p>

                </div>

                <div class="added-package">
                <h3> Paradise Package - Super</h3>
                <p>Pick up, 2 Weeks Storage ($2000 per day thereafter), Embalm, Preparation, Hearse, Regular or Semi-Customized Casket, Casket Spray, Wreath + Arrangement,
                  SingleVault (Dovecot or Meadowrest), 200 Programs + Bands for Set up, 200 Book markers or Prayer cards + 100 Buttons, 2 TVJ Death Announcement, 1 Gleaner Advertisment + 1 JUTC Bus</p>

                </div>

                <div class="added-package-photo">
               <div class="added-package-photo1">
               <img src="../assets/img/garden3.png">
                </div>
                </div>

                <div class="added-package-photo">
               <div class="added-package-photo1">
               <img src="../assets/img/garden4.png">
                </div>
                </div>
